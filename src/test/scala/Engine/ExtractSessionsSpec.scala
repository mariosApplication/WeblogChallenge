...
class ExtractSessionsSpec extends FlatSpec with Matchers with BeforeAndAfterAll {
  ...
  "Extract sessions" should "extract all sessions for each ip" in {
    val expected = Array(
      ...
      ("180.179.74.201:51852", Some(List(List(2.3959260555866666E7)))),
      ("59.94.106.79:8346", Some(List(List(2.3959260613066666E7)))),
      ("54.251.151.39:44347", Some(List(List(2.39592606393E7)))))
